...
class AI_Filter_Level():
    ...
    def leave_one_out(self,df,type,trainning_type):
        ...
        for i in range (0, len(X)):
            ...
            print('test len',len(self.test_x))
            print('train len',len(self.train_x))
        ...
        print("final pred length : ", len(self.ans_list) )
        print("final pred answer cnt : ", sum(self.ans_list) )
        print("final result : ", sum(self.ans_list)/len(self.ans_list) * 100)
